        ...
        <div class="form-wrapper">
            <form class="form-horizontal" action="" method="post">
                ...
                <div class="box-footer">
                    ...
                    @if(Form::getData('id'))
                        <a href="{{ route('auth.user.delete', ['id' => Form::getData('id'), 'token' => csrf_token() ]) }}" class="btn btn-danger delete-confirm" >
                            Delete
                        </a>
                    @endif
                    <a href="{{ route('auth.user.list') }}" class="btn btn-info">Back</a>
                </div>
                <div class="box-body">
                    ...
                    <div class="tab-content">
                        <div id="item-general" class="tab-pane active">
                            @include('gsdw_permission::user.tab.general')
                        </div>
                    </div>
                </div>
            </form>
